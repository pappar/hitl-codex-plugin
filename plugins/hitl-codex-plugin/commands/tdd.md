...
>
> - If the architect is still in the design phase, wait for them to complete `/architect-design-feature` and reach all gates.
> - If a gate is awaiting review, the TA must run `/ta-approve` to advance it.
